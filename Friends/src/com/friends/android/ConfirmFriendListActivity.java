...
import com.friends.android.ConfirmFriendListActivity.RefreshAvatarThread;
...
public class ConfirmFriendListActivity extends Activity {

    
    public static final String DEBUG_TAG = "ConfirmFriendListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirm_friend_list);
        initActionBar();
    ...
    public class RefreshAvatarThread extends Thread {
        ...
        public void run() {
            try {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(ConfirmFriendListActivity.this, temp.message, Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                Intent intent = new Intent(ConfirmFriendListActivity.this, LogingWebActivity.class);
    ...
    public class RefreshDataThread extends Thread {
        ...
        public void run() {
            try {
                FClient client = new FClient();
                client.setUserToken(MainApplication.userToken);
                JSONObject jsonObject = new JSONObject(client.userGetAddFriendAsks(1));
    ...
    public void onBackPressed() {
        ...
        new AcceptAsksThread(contactIds).start();
        super.onBackPressed();
    }
    
    public class AcceptAsksThread extends Thread {
        private List<String> contactIds;
        
        public AcceptAsksThread(List<String> contactIds) {
        ...
        public void run() {
            try {
                FClient client = new FClient();
                client.setUserToken(MainApplication.userToken);
                client.userAddFriend(contactIds);
            } catch (InvalidAccessToken e) {
                // TODO: handle exception
                final InvalidAccessToken temp = e;
                runOnUiThread(new Runnable() {
    ...
    public class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (mHasSelected.get(position)) {
                ...
                imageView.setImageResource(R.drawable.icon_add_dgray);
            }
